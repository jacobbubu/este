...
class MonacoEditor extends React.Component {
  ...
  afterViewInit() {
    ...
    const onGotAmdLoader = () => {
      if (context.__REACT_MONACO_EDITOR_LOADER_ISPENDING__) { //eslint-disable-line
        // Do not use webpack
    ...
    if (context.__REACT_MONACO_EDITOR_LOADER_ISPENDING__) {
      // We need to avoid loading multiple loader.js
      // when there are multiple editors loading concurrently
  ...
  initMonaco() {
    ...
    const context = this.props.context || window;
    if (typeof context.monaco !== 'undefined' && this.container) {
      // Before initializing monaco editor
      this.editorWillMount(context.monaco);
      this.editor = context.monaco.editor.create(this.container, {
        value,
        language,
        theme,
        fontSize,
